...
const sG = EStyleSheet.create({
  ...
  bg_gray: { backgroundColor: '$colorGray' },
  ...
  icon_max: { borderRadius: "120rem" },
  icon_xs: { height: '25rem',  width: '25rem'},
  icon_md: { height: '40rem',  width: '40rem'},
  icon_xl: { height: '100rem',  width: '100rem'},
  size_icon: {fontSize: '25rem'},
  size_icon_xs_xs: {fontSize: '10rem'},
  size_icon_xs: {fontSize: '15rem'},
  size_icon_sm: {fontSize: '30rem'},
  ...
  row_85: { flex: 1, aspectRatio: 1 / 0.85 },
  ...
  p_y_xs_xs: { paddingVertical: '5rem' },
